...
\begin{outline}
  ...
  \dbullet{3.4.1 (Independent Events)}
  ...
  \dbullet{3.4.3 (Ternary Independence)}
  ...
  \dbullet{3.4.4 (n-ary Independence)}
  ...
  \pbullet{3.5.1 (Axiomatic Satisfiability)}
